...
FROM T_Sponsors
Where T_Sponsors.SponsorType ='C' " );
...
<tr><td colspan="6" align="center"><font size = "4" color="red"> GTDL Charity Partners</font></td></tr>
<tbody>
<tr valign="center">
  ...
  <th scope="col" width="30%"><p>What do they do?</p></th>
</tr>
</tbody>
<?php

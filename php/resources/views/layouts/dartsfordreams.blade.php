...
<script>
  ...
  <div class="container-fluid">
    @include('shared.defaultnav', ['navtype' => 'dartsfordreams'])
  </div>
  <div class="container-fluid">
    <div id="body-content">
      <div id="header-options" class="pull-right">
        ...
        <a href="http://www.trentondarts.com/php/suggestionbox.php"><img src="{{ asset('images/sbox.jpg') }}" title="Suggestions"/></a>
      </div>
